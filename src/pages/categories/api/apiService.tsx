...
export const fetchProducts = async () :Promise<ProductAPIResponse>   => {
    const res = await fetch('https://ecommercetemplate.pythonanywhere.com/api/v1/product/category/');
...
//     }
//     const url = `https://ecommercetemplate.pythonanywhere.com/api/v1/product/item/suggestions/?${params.toString()}`;
