                ...
                >
                  <div className="bg-[#F0EEED] rounded-lg p-14 relative">
                    <img
                      src={item.image1}
                      alt={item.name}
                      className="w-full h-[150px] object-cover shadow-lg"
                    />
                    <button
                  ...
                  <div className="p-3 sm:p-4">
                    <h3 className="text-xl sm:text-lg font-normal text-gray-800 truncate uppercase">
                      {item.name}
                    </h3>
                    <div className="mt-2 flex flex-wrap items-center gap-2">
                      <span className="text-2xl sm:text-xl font-normal text-primary">
