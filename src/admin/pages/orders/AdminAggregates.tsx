...
import { FiShoppingBag, FiTruck, FiPackage, FiTrendingUp, FiTrendingDown } from "react-icons/fi";
    ...
    <div className='lg:mr-40'>
        <div className="flex gap-4 flex-wrap items-center border border-[#E6EDFF] rounded-2xl lg:p-6 p-2 lg:pr-12 mt-6">
            <div className="border-r border-[#E6EDFF] basis-[40%] sm:basis-auto lg:pr-10 pr-5">
                ...
                <p className="mb-2.5 lg:font-normal text-[14px]">Total Orders</p>
            ...
            <div className="border-r border-[#E6EDFF] basis-[40%] sm:basis-auto lg:px-5 px-2">
                ...
                <p className="mb-2.5 lg:font-normal text-[14px]">Delivered Orders</p>
                <p className="flex items-center">
                    <FiTrendingUp className="text-[#34C759] lg:mr-2.5 mr-1" />
                    <span className="lg:text-[14px] text-[10px] lg:mr-2.5 mr-1">10.2</span>
                    <span className="lg:text-[14px] text-[10px]">+1.01% this week</span>
            ...
            <div className="border-r border-[#E6EDFF] basis-[40%] sm:basis-auto lg:px-5 px-2">
                ...
                <p className="mb-2.5 lg:font-normal text-[14px]">Returned Orders</p>
                <p className="flex items-center">
                    <FiTrendingUp className="text-[#34C759] lg:mr-2.5 mr-1" />
            ...
            <div className="border-r border-[#E6EDFF] basis-[40%] sm:basis-auto lg:px-5 px-2">
                ...
                <p className="mb-2.5 lg:font-normal text-[14px]">Pending Orders</p>
                <p className="flex items-center">
        ...
        <div className="flex flex-wrap gap-4 items-center border border-[#E6EDFF] rounded-2xl lg:p-6 p-2 lg:pr-12 mt-6">
            <div className="border-r border-[#E6EDFF] basis-[40%] sm:basis-auto lg:pr-10 pr-5">
                <div className="flex justify-between items-center mb-2.5">
                ...
                <p className="mb-2.5 lg:font-normal text-[14px]">Total Payment</p>
                <p className="flex items-center">
                    <FiTrendingUp className="text-[#34C759] lg:mr-2.5 mr-1" />
                    <span className="lg:text-[14px] text-[10px] lg:mr-2.5 mr-1">10.2</span>
                    <span className="lg:text-[14px] text-[10px]">+1.01% this week</span>
            ...
            <div className="border-r border-[#E6EDFF] basis-[40%] sm:basis-auto lg:px-5 px-2">
                ...
                <p className="mb-2.5 lg:font-normal text-[14px]">Successful Payment</p>
                <p className="flex items-center">
                    <FiTrendingUp className="text-[#34C759] lg:mr-2.5 mr-1" />
            ...
            <div className="border-r border-[#E6EDFF] basis-[40%] sm:basis-auto lg:px-5 px-2">
                ...
                <p className="mb-2.5 lg:font-normal text-[14px]">Refunded Payment</p>
                <p className="flex items-center">
